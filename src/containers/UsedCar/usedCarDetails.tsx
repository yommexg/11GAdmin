      ...
      {usedCar && (
        <div className="md:ml-[250px]">
          <div className=" mb-2 px-4 py-3 md:py-6 md:px-8 flex lg:px-15 items-center justify-between gap-2 bg-white shadow-2xl">
            ...
            />
            <h2
              className=" flex flex-col lg:flex-row items-center font-bold text-sm sm:text-base uppercase md:text-lg text-center lg:gap-1
                "
              style={{
                color:
          ...
          <div
           ...
           bg-gray-200 px-2 py-6 justify-between md:px-10 text-wrap"
          >
            <UsedCarAddress />
            <OtherUsedCarDetails />
          </div>
